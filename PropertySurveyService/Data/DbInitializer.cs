    ...
    public static class DbInitializer
    {
        ...
        public static void Initialize(AppDBContext context)
        {
            ...
            var agents = new Agent[]
            {
                ...
                new Agent{Name="Jim Halpert", Code="H10", Type=agent_type.Surveyor },
                new Agent{Name="Pam Beesly", Code="H11", Type=agent_type.Satellite },
                new Agent{Name="Dwight Schrute", Code="H12", Type=agent_type.Fitter },
                new Agent{Name="Ryan Howard", Code="HH12", Type=agent_type.Satellite },
                new Agent{Name="Kelly Kapoor", Code="HH13", Type=agent_type.Fitter },
                new Agent{Name="Toby Flenderson", Code="H13", Type=agent_type.Surveyor },
                new Agent{Name="Stanley Hudson", Code="H14", Type=agent_type.Fitter },
                new Agent{Name="Phyllis Vance", Code="H15", Type=agent_type.Surveyor },
                new Agent{Name="Meredith Palmer", Code="HH14", Type=agent_type.Satellite },
                new Agent{Name="Creed Bratton", Code="HH15", Type=agent_type.Fitter },
                new Agent{Name="Andy Bernard", Code="H16", Type=agent_type.Surveyor },
                new Agent{Name="Erin Hannon", Code="H17", Type=agent_type.Satellite },
                new Agent{Name="Darryl Philbin", Code="H18", Type=agent_type.Fitter },
                new Agent{Name="Robert California", Code="HH16", Type=agent_type.Surveyor },
                new Agent{Name="Gabe Lewis", Code="HH17", Type=agent_type.Satellite },
                new Agent{Name="Clark Green", Code="H19", Type=agent_type.Fitter },
                new Agent{Name="Pete Miller", Code="H20", Type=agent_type.Surveyor },
                new Agent{Name="David Wallace", Code="H21", Type=agent_type.Satellite },
                new Agent{Name="Jan Levinson", Code="HH18", Type=agent_type.Surveyor },
                new Agent{Name="Roy Anderson", Code="HH19", Type=agent_type.Fitter },
                new Agent{Name="Holly Flax", Code="H22", Type=agent_type.Surveyor },
                new Agent{Name="Nellie Bertram", Code="H23", Type=agent_type.Satellite },
                new Agent{Name="Charles Miner", Code="H24", Type=agent_type.Fitter },
                new Agent{Name="Jo Bennett", Code="HH20", Type=agent_type.Surveyor },
                new Agent{Name="Danny Cordray", Code="HH21", Type=agent_type.Satellite },
                new Agent{Name="Karen Filippelli", Code="H25", Type=agent_type.Surveyor },
                new Agent{Name="Todd Packer", Code="H26", Type=agent_type.Fitter },
                new Agent{Name="Bob Vance", Code="H27", Type=agent_type.Satellite },
                new Agent{Name="Hank Tate", Code="HH22", Type=agent_type.Fitter },
                new Agent{Name="Mose Schrute", Code="HH23", Type=agent_type.Satellite }
            };
