...
namespace PropertySurveyService.Controllers
{
    public class BifoldTablesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,HeaderId,udi_cont,item_number,ernal_width,ernal_height,overall_width,overall_height,opens,trickle_vents,hardware,color_ernal,color_external,threshold_type,no_of_pics,no_of_photos,no_of_vids,bComplete,comments,bifold_signed,number_of_doors,cause_of_damage,cause_of_damage_reason_different,door_type,glazing_options,number_of_doors_text,colour_of_doors,handle_colour,cill_type,knock_on,ernal_door_colour,s_spare12,parts_to_order,type_of_lockng_system_required,was_it_locked,point_of_entry,ChangeItemTo,pr_name,bDifferentFromOriginal,glass_complete,replace_glass,reason_not_repaired,bRepair,fensa,WER_rating,gaskets,gaskets_text,handles_req,bHandleDrawingComplete,handles_text,addons,addon_width,addon_height")] BifoldTable bifoldTable)
        {
